...
-- inspectable/requêtable via les opérateurs JSON de Postgres. `execution`
-- (voir tools::ToolExecution) est également en JSONB plutôt qu'une colonne
-- par variante, pour ne pas avoir à migrer le schéma à chaque nouvelle
-- variante.
CREATE TABLE IF NOT EXISTS tool (
    name TEXT PRIMARY KEY,
    description TEXT NOT NULL,
    parameters_schema JSONB NOT NULL,
    execution JSONB NOT NULL DEFAULT '"Native"'
);
