...
pub struct VFS {
    ...
    aliases: Option<Arc<dyn alias::AliasCatalog>>,
}
...
impl VFS {
    ...
    pub fn with_aliases(aliases: Arc<dyn alias::AliasCatalog>) -> Self {
    ...
    pub async fn mount(&self, prefix: &str, fs: Arc<dyn FileSystem>) {
        ...
        mounts.sort_by_key(|(b, _)| std::cmp::Reverse(b.len()));
    }
...
mod vfs_tests {
    ...
    use crate::vfs::alias::AliasCatalog;
